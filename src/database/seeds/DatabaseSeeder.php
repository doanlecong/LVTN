...
class DatabaseSeeder extends Seeder
{
    ...
    //         $this->loai_vai['1']->id,
    //         $this->mau['1']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['2']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['2']->id,
    //         $this->mau['2']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['3']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['3']->id,
    //         $this->mau['3']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['4']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['4']->id,
    //         $this->mau['4']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['5']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['5']->id,
    //         $this->mau['5']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['6']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['6']->id,
    //         $this->mau['5']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    //     ]);
    //     $this->lonhuom['7']=App\LoNhuom::firstOrCreate([
    //         $this->loai_vai['6']->id,
    //         $this->mau['5']->id,
    //         $this->nhan_vien['ngoc']->id,
    //         'ngay_gio_nhuom'=>date('Y:m:d H:m:s'),
    ...
    //         //'loai_soi_id'=>1,
    //     ]);
    //      $this->loai_vai['2']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'Kaki',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>1,
    //     ]);
    //      $this->loai_vai['3']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'Polyester',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>3,
    //     ]);
    //      $this->loai_vai['4']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'CVC',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>3,
    //     ]);
    //      $this->loai_vai['5']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'TC',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>6,
    //     ]);
    //      $this->loai_vai['6']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'Lua',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>6,
    //     ]);
    //      $this->loai_vai['7']=App\LoaiVai::firstOrCreate([
    //         'ten'=>'Thun',
    //         'don_gia'=>50000,
    //         //'loai_soi_id'=>6,
    //     ]);
    ...
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Trần Văn Hùng',
    //         'ten_dang_nhap'=>'hung',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'648 Thành Thái, Q.10',
    //         'email'=>'hieu@gmail.com',
    //         'so_dien_thoai'=>'0934689574',
    //         'cong_no'=>4000000,
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Nguyễn Thị Mai',
    //         'ten_dang_nhap'=>'mai',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'394 Lữ Gia, Q.11',
    //         'email'=>'mai@gmail.com',
    //         'so_dien_thoai'=>'0923469571',
    //         'cong_no'=>2600000,
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Đỗ Văn Phúc',
    //         'ten_dang_nhap'=>'phuc',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'267 Tô Hiến Thành, Q.10',
    //         'email'=>'phuc@gmail.com',
    //         'so_dien_thoai'=>'0934698571',
    //         'cong_no'=>3200000,
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Nguyễn Ngọc Nhân',
    //         'ten_dang_nhap'=>'nhan',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'167 Nguyễn Kiệm, Q.Gò Vấp',
    //         'email'=>'nhan@gmail.com',
    //         'so_dien_thoai'=>'0937468134',
    //         'cong_no'=>0,
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Lê Trung Long',
    //         'ten_dang_nhap'=>'long',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'369 Phạm Hữu Lầu, P.6, TP.Cao Lãnh, Đồng Tháp',
    //         'email'=>'long@gmail.com',
    //         'so_dien_thoai'=>'0904687231',
    //         'cong_no'=>0,
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Đỗ Chí Công',
    //         'ten_dang_nhap'=>'cong',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'267 Bạch Đằng, Q.Hải Châu, Đà Nẵng',
    //         'email'=>'cong@gmail.com',
    //         'so_dien_thoai'=>'0916487265',
    //         'cong_no'=>0
    //     ]);
    //     $this->khachhang['1']= App\KhachHang::firstOrCreate([
    //         'ten'=>'Trương Đức Toàn',
    //         'ten_dang_nhap'=>'toan',
    //         'mat_khau'=>Hash::make('1234abc'),
    //         'dia_chi'=>'24 Nguyễn Tri Phương, Q.5',
    //         'email'=>'toan@gmail.com',
    //         'so_dien_thoai'=>'0924876213',
    //         'cong_no'=>0,
    //     ]);

    // }
    // public function cayvaimoc_seeder(){
    //     $this->cayvaimoc = App\CayVaiMoc::firstOrCreate([
    //         'loai_vai_id'=>1,
    //         'so_met'=>100,
    //         'nhan_vien_det_id'=>$this->nhan_vien['ngoc']->id,
    //         'ma_may_det'=>1,
    //         'ngay_gio_det'=>date('Y:m:d H:m:s'),
    //         'kho_id'=>$this->kho['kho_soi_1']->id,
    //         'ngay_gio_nhap_kho'=>date('Y:m:d H:m:s'),
    //         //'phieu_xuat_moc_id'=>
    //         //'lo_nhuom_id'=>
    //     ]);
    //     $this->cayvaimoc = App\CayVaiMoc::firstOrCreate([
    ...
    //         'loai_vai_id'=>2,
    //         'so_met'=>100,
    //         'nhan_vien_det_id'=>$this->nhan_vien['dung']->id,
    //         'ma_may_det'=>4,
    //         'ngay_gio_det'=>date('Y:m:d H:m:s'),
    //         'kho_id'=>$this->kho['kho_soi_1']->id,
    //         'ngay_gio_nhap_kho'=>date('Y:m:d H:m:s'),
    ...
    //     ]);
    // }
    // public function phieuxuatmoc_seeder(){
    //     $this->phieuxuatmoc= App\PhieuXuatMoc::firstOrCreate([
    //         'loai_vai_id'=>1,
    //         'tong_so_cay_moc'=>0,
    //         'tong_so_met'=>0,
    //         'kho_id'=>1,
    ...
    //     ]);
    // }
    // public function cayvaithanhpham_seeder(){
    //     $this->caythanhpham=App\CayVaiThanhPham::firstOrCreate([
    //         'cay_vai_moc_id'=>1,
    //         'loai_vai_id'=>1,
    //         'kich_co'=>1.5,
    //         'so_met'=>100,
